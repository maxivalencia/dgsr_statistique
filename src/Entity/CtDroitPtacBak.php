 ...
 * CtDroitPtacBak
 *
 * @ORM\Table(name="ct_droit_ptac_bak", indexes={@ORM\Index(name="IDX_DB918ADA12DA9529", columns={"ct_genre_categorie_id"}), @ORM\Index(name="IDX_DB918ADA7CFDF4AC", columns={"ct_type_droit_ptac_id"})})
 * @ORM\Entity
 */
